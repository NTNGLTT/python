...
def score(r1,r2,r3,r4,r5,r6,r7,r8,r9,r10):
  gabarito = ['D','B','D','A','C','D','A','B','D','C']
  respostas = [r1,r2,r3,r4,r5,r6,r7,r8,r9,r10]
  
  if respostas == gabarito:
    print("Você gabaritou!!! ")
  ...
  if placar > 350:
    ...
    print("Você consegue melhorar!! Não desista!")
...
while repet > 0:
  ...
  if q1 == "D":
    print("\nParabéns, essa é a resposta correta! O maior causador dos fenômenos climáticos na Terra é o efeito estufa, que provoca o aquecimento global. ")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, o grande responsável pelas mudanças climáticas na Terra é o efeito estufa, sendo ele quem provoca o aquecimento global. ")
    placar = placar - 20
  ...
  if q2 == "B":
    print("\nParabéns, essa é a resposta correta! O aquecimento global se dá ao aumento da temperatura do planeta Terra.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, o aquecimento global é o aumento da temperatura do planeta Terra.")
    placar = placar - 20
  
  print("\n3. Quais ações humanas descritas, provocam a maior produção de gases na atmosfera? ")
  
  print("A-) Jogar lixo no rio.")
  print("B-) Todas as respostas.")
  print("C-) Cortar Arvores.")
  ...
  if q3 == "D":
    print("\nParabéns, essa é a resposta correta! A queima de madeira, combustão da gasolina e materiais nas indústrias é a principal causa da produção de gases na atmosfera.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, a maior causadora da produção de gases na atmosfera é a queima de madeira, combustão da gasolina e materiais nas indústrias.")
    placar = placar - 20
  
  print("\n4. O que é o efeito estufa? Ele é prejudicial ou não? ")
  ...
  if q4 == "A":
    print("\nParabéns, essa é a resposta correta! O efeito estufa é uma consequência do aquecimento global, assim sendo prejudicial é um fenômeno natural que ocorre a partir da concentração de gases na atmosfera que formam uma camada que bloqueia a volta de raios UV logo aquece o planeta.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, o efeito estufa é uma consequência do aquecimento global, assim sendo prejudicial é um fenômeno natural que ocorre a partir da concentração de gases na atmosfera que formam uma camada que bloqueia a volta de raios UV logo aquece o planeta.")
    placar = placar - 20
  
  print("\n5. As mudanças climáticas estão ocorrendo e já é possível notar algumas modificações que provavelmente relacionam-se com a ação do homem. Assim sendo, são necessárias ações urgentes para que nosso impacto no meio ambiente seja reduzido. Analise as alternativas abaixo e marque aquela que não indica uma forma de deter o avanço das mudanças climáticas.")
  ...
  if q5 == "C":
    print("\nParabéns, essa é a resposta correta! A queima de combustíveis fósseis causa a produção de gases que intensificam o efeito estufa, sendo uma maneira, portanto, de acelerar as mudanças climáticas.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, o que agravaria as mudanças climáticas seria aumentar o uso de combustíveis fósseis, que geraria mais gases e aumentaria ainda mais o efeito estufa.")
    placar = placar - 20
  
  print("\n6. Muitas pessoas acreditam que as mudanças climáticas afetam exclusivamente a temperatura do planeta, que se torna mais quente. Entretanto, muitas vezes, essas pessoas esquecem que, ao aumentar a temperatura, uma série de organismos e ecossistemas são gravemente afetados. Observe as alternativas abaixo e marque a única que não é uma consequência da alteração da temperatura do planeta. ")
  ...
  if q6 == "D":
    print("\nParabéns, essa é a resposta correta! Os terremotos ocorrem por causa de movimentações das placas tectônicas, não havendo ligação, portanto, com o aumento da temperatura.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, seria o aumento da frequência de terremotos. Porque o aumento da temperatura não interfere no movimento das placas tectônicas.")
    placar = placar - 20
  
  print("\n7. Cientistas acreditam que o reflorestamento e o plantio de árvores em áreas sem vegetação podem contribuir para minimizar o aquecimento global. A redução desse aquecimento ocorreria porque: ")
  ...
  if q7 == "A":
    print("\nParabéns, essa é a resposta correta! Diminuiria a quantidade de dióxido de carbono na atmosfera, que sería utilizado como alimento das plantas para a realização da fotossíntese.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, diminuiria a quantidade de dióxido de carbono na atmosfera, que sería utilizado pela fotossíntese.")
    placar = placar - 20
  
  print("\n8. Assinale a alternativa que NÃO APRESENTA uma consequência do aquecimento global:")
  ...
  if q8 == "B":
    print("\nParabéns, essa é a resposta correta! Desflorestamento e queimadas das áreas de matas é uma das causas do aquecimento global, não consequência.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade, esta é de fato uma consequência do aquecimento global, já o desflorestamento e queimadas das áreas de matas é uma causa do mesmo.")
    placar = placar - 20
  
  print("\n9. Nos últimos anos, observa-se um aumento crescente do percentual de CO2 na atmosfera. Entre outros efeitos, o excesso de CO2 pode contribuir para:")
  ...
  if q9 == "D":
    print("\nParabéns, essa é a resposta correta! O excesso pode contribuir para o aquecimento global.")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade,  excesso pode contribuir para o aquecimento global.")
    placar = placar - 20
  
  print("\n10. Sobre o aquecimento global, que é o processo de elevação das temperaturas médias da Terra ao longo do tempo, marque a alternativa correta.")
  ...
  if q10 == "C":
    print("\nParabéns, essa é a resposta correta! O efeito estufa tem como causa principal a emissão de poluentes para a atmosfera dos chamados gases-estufa. Os gases-estufa mais conhecidos são o dióxido de carbono e o gás metano.\n")
    placar = placar + 50
    qtdcerto = qtdcerto + 1
  else:
    print("\nResposta incorreta! Na verdade a elevação média das temperaturas se dá principalmente pela emissão de gases poluentes que interferem na volta dos raios UV para a estratosfera.\n")
    placar = placar - 20
